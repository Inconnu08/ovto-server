...
func TestMenu(t *testing.T) {
	...
	var tt = []testdata {
		// success condition
		{Label: "Test should create Menu successfully", Condition: "success", Want: nil, Name: "Cheesy Sandwich", Desc:"Very cheesy?!", Price:150, Category:1},
